...
contract XP_Token is ERC20, ERC20Detailed {
    ...
    modifier onlyOwner {
        require(msg.sender == owner, "You do not have permission to mint these tokens!"); // @TODO: add a `require` to check if `owner` is the `msg.sender`
    ...
    constructor(uint initial_supply) ERC20Detailed("XPToken", "XPT", 18) public {
